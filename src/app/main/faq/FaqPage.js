		...
		<div className="w-full flex flex-col flex-auto">
			...
			>
				...
				<FuseAnimate animation="transition.slideUpIn" duration={400} delay={100}>
					<Typography color="inherit" className="text-16 sm:text-28 font-light">
					Here is the list of some most common questions. If you have any other questions please feel free to contact out us!
					</Typography>
				</FuseAnimate>
			...
			<div className="flex flex-col flex-1 flex-shrink-0 max-w-xl w-full mx-auto px-16 sm:px-24 py-24 sm:py-32">
				<span className="text-28 mb-14">FAQ (How it works)</span>
